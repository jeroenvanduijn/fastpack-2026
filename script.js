...
[1, 2, 3, 4].forEach(n => {
  ...
  if (n === 2) {
    ...
    // Realistic Monte Rosa Profile (Etappes 1,2,6,7,8,9,10)
    heights = [
      10, 25, 40, 55, 70, 80, 85, 90,             // E1
      85, 80, 70, 60, 50, 40, 30, 20, 15,         // E2
      15, 25, 40, 55, 70, 85, 95, 100,            // E6
      100, 95, 80, 65, 50, 35, 25, 15,            // E7
      15, 30, 45, 60, 75, 85, 75, 65, 50,         // E8
      50, 60, 70, 80, 70, 55, 40, 25, 15,         // E9
      15, 30, 45, 55, 65, 75, 60, 40, 15          // E10
    ];
  } else {
